...
import test.saml.JhipstersamlApp;
import test.saml.config.audit.AuditEventConverter;
import test.saml.domain.PersistentAuditEvent;
import test.saml.repository.PersistenceAuditEventRepository;
import test.saml.service.AuditEventService;
...
@SpringBootTest(classes = JhipstersamlApp.class)
@Transactional
